    ...
    public class HomeController : Controller
    {
        ...
        public HomeController(ApplicationContext context)
        {
            ...
            if(db.Mobiles.Count() == 0)
            {
                ...
                Mobile iphone10 = new Mobile { Name = "Iphone 10", BrandName = apple.Name, Brand = apple};
                Mobile googlePixel3 = new Mobile { Name = "Google Pixel 3", BrandName = google.Name, Brand = google};
                Mobile iphone11 = new Mobile { Name = "Iphone 11", BrandName = apple.Name, Brand = apple};
